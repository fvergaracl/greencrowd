    ...
    <div className='p-6 max-w-4xl mx-auto'>
      <div className='bg-white shadow-md rounded-lg p-6 mb-6 flex items-center'>
        ...
        <div className='ml-6'>
          ...
          <p className='font-medium text-gray-800'>{user?.id || t("No ID")}</p>
          <hr className='my-4' />

          <p className='text-gray-600' data-cy='settings-user-name-label'>
            {t("Name")}:
          </p>
          <p className='font-medium text-gray-800' data-cy='settings-user-name'>
            {user?.name || t("No Name")}
          </p>
          <p className='text-gray-600 mt-2' data-cy='settings-user-email-label'>
            {t("Email")}:
          </p>
          <p
